...
import { FaHtml5, FaCss3Alt, FaJsSquare, FaBootstrap, FaGithub, FaTerminal } from 'react-icons/fa';
// ─────────────────────────────────────────────────────────────────────── 
const skills = [
  ...
  { name: 'Basic Linux', icon: <SiLinux className="text-3xl sm:text-6xl text-[#FCC624]" /> },
  { name: 'JQuery', icon: <SiJquery className="text-3xl sm:text-6xl text-[#0769AD]" /> },
  { name: 'Shell Scripting', icon: <SiGnubash className="text-3xl sm:text-6xl text-[#4EAA25]" /> },
  { name: 'UNIX', icon: <FaTerminal className="text-3xl sm:text-6xl text-[#4D4D4D]" /> },
  { name: 'Git', icon: <SiGit className="text-3xl sm:text-6xl text-[#F05032]" /> },
];
