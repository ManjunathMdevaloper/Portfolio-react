        ...
        <footer className="relative bg-gradient-to-b from-[#0B2447] via-[#19376D] to-[#0B2447] text-white py-12 overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6">
                ...
                <div className="flex justify-center gap-8 mb-10">
                    {[{
                        icon: FaGithub,
                        href: "https://github.com/ManjunathMdevaloper"
                    }, {
                        icon: FaInstagram,
                        href: "https://www.instagram.com/mr_manjunath0?igsh=MndyaG1zMnZueWRs"
                    }, {
                        icon: FaTwitter,
                ...
                <p className="text-center text-sm text-white/70">
                    © {new Date().getFullYear()} <span className="font-bold text-[#00c6ff]">Manke Manjunath</span>. All rights reserved.
                </p>
            </div>
        </footer>
    );
